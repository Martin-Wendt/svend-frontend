...
@Component({
  selector: 'app-manager-tab-edit',
  templateUrl: './manager-tab-edit.page.html',
  styleUrls: ['./manager-tab-edit.page.scss'],
})
export class ManagerTabEditPage implements OnInit {
